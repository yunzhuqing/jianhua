...
function getGrid() {
    ...
    var table = new TreeTable(TreeGrid.id, '../suggest/innerList', columns);
...
TreeGrid.initColumn = function () {
    var columns = [
        ...
        {title: '推荐场景', field: 'scene', align: 'center', valign: 'middle', width: '50px', formatter: function (value) {
                if(1 == value.scene) {
                    return "首页轮播";
        ...
        {title: '名称', field: 'itemFirst', align: 'center', valign: 'middle', width: '50px'},
        {title: '顺序', field: 'order', align: 'center', valign: 'middle', width: '50px'},
...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            var url = vm.suggest.id == null ? "../suggest/save" : "../suggest/update";

            Ajax.request({
                type: "POST",
                url: url,
                contentType: "application/json",
                params: JSON.stringify(vm.suggest),
