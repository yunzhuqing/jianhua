...
//        }
        //
        resultObj.put("defaultKeyword", null);
        resultObj.put("historyKeywordList", null);
        resultObj.put("hotKeywordList", null);
    ...
    @IgnoreAuth
    @GetMapping("helper")
    public Object helper(@LoginUser SysUserEntity loginUser, String keyword) {
        Map param = new HashMap();
        param.put("fields", "distinct keyword");
    ...
    public Object clearhistory(@LoginUser SysUserEntity loginUser) {
